...
-- AlterTable
ALTER TABLE public."PromoPlacement" ADD COLUMN "slot_tmp" public."PromoSlot";
UPDATE public."PromoPlacement" SET "slot_tmp" = ("slot"::text)::public."PromoSlot";
ALTER TABLE public."PromoPlacement" ALTER COLUMN "slot_tmp" SET NOT NULL;
ALTER TABLE public."PromoPlacement" DROP COLUMN "slot";
ALTER TABLE public."PromoPlacement" RENAME COLUMN "slot_tmp" TO "slot";
...
-- CreateIndex
CREATE INDEX "ProductMedia_productId_kind_order_idx" ON "public"."ProductMedia"("productId" ASC, "kind" ASC, "order" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "ProductMedia_productId_order_key" ON "public"."ProductMedia"("productId" ASC, "order" ASC);

-- CreateIndex
CREATE INDEX "files_mimetype_idx" ON "public"."files"("mimetype" ASC);

-- CreateIndex
CREATE INDEX "files_type_status_idx" ON "public"."files"("type" ASC, "status" ASC);

-- CreateIndex
CREATE INDEX "files_uploadedById_idx" ON "public"."files"("uploadedById" ASC);

-- CreateIndex
CREATE INDEX "PromoPlacement_pageType_entityId_slot_isActive_order_idx" ON "public"."PromoPlacement"("pageType" ASC, "entityId" ASC, "slot" ASC, "isActive" ASC, "order" ASC);
