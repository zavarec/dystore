# DyStore v1 - Интернет-магазин техники Dyson
...
```env
SITE_URL=https://dystore.ru
NEXT_PUBLIC_API_URL=https://api.dystore.ru
```
...
# DyStore Frontend - Интеграция с Backend

## Описание

Next.js приложение интернет-магазина DyStore с интегрированной аутентификацией по номеру телефона.
