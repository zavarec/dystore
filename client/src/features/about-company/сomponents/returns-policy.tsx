...
export const ReturnsPolicy: React.FC<{
  ...
  <PoliciesLayout current="returns" title="Условия возврата товара" breadcrumbsPrefix={breadcrumbs}>
    <AboutCompanyPageWrapper>
      <AboutCompanyContainer>
        <AboutCompanySection>
          <AboutCompanyText>
            Мы стремимся, чтобы покупки приносили только положительные впечатления. Если товар вам
            не подошёл, вы можете оформить возврат в установленные сроки при соблюдении условий
            ниже.
          </AboutCompanyText>
          ...
          <AboutCompanyList>
            ...
            <li>
              Технически сложные товары подлежат возврату при наличии производственного дефекта либо
          ...
          <AboutCompanyList>
            <li>
              ...
              <strong>{COMPANY_INFO.COMPANY_PHONE_NUMBER}</strong>.
            </li>
            <li>
              Укажите номер заказа, причину возврата и приложите фото/видео (при необходимости).
            </li>
            <li>
              Мы согласуем способ возврата: курьером, в пункт выдачи или самовывозом (если
              доступно).
            </li>
          </AboutCompanyList>
